...
arr_code1 = mpimg.imread('/content/qrcode.png')
imagebox = OffsetImage(arr_code1, zoom=0.25)
ab1 = AnnotationBbox(imagebox, (0.83, 0.10))
ax.add_artist(ab1)
...
from matplotlib.offsetbox import TextArea, DrawingArea, OffsetImage, AnnotationBbox
import matplotlib.image as mpimg
arr_code = mpimg.imread('/content/young-woman-passport-photo-concept-metaphor-vector-32037470.jpg')
imagebox = OffsetImage(arr_code, zoom=0.10)
ab = AnnotationBbox(imagebox, (0.55, 0.91))
ax.add_artist(ab)
